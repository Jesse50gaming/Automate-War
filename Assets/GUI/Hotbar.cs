...
namespace Container
{
    ...
    public class Hotbar
    {
        ...
        public Hotbar(HotbarScript hotbarScript)
        {
            ...
            hotbarInventory.SwapItem(hotbarHeight-1,0,new DirtItem(2));
            hotbarInventory.SwapItem(hotbarHeight-1,1,new StoneItem(5));
            hotbarInventory.SwapItem(hotbarHeight-1,2,new DirtItem(1));
            hotbarInventory.SwapItem(hotbarHeight-1,3,new StoneItem(55));
            hotbarInventory.SwapItem(hotbarHeight-1,4,new DirtItem(64));
            hotbarInventory.SwapItem(hotbarHeight-1,5,new StoneItem(9));
            hotbarInventory.SwapItem(hotbarHeight-1,6,new DirtItem(100));
            hotbarInventory.SwapItem(hotbarHeight-1,7,new StoneItem(17));
            hotbarInventory.SwapItem(hotbarHeight-1,8,new DirtItem(12));
            hotbarInventory.SwapItem(hotbarHeight-1,9,new StoneItem(61));
        ...
        public void addItem(int slot,Item item)
        {
            ...
            hotbarInventory.SwapItem(hotbarHeight-1, slot, item);
